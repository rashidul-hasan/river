                            ...
                            <div class="col-md-8">
                                <div class="file-input">
                                    <input type="file" name="meta_img" id="meta_img" class="file-input__input"
                                           onchange="singleImagePreview(event,'ImgPreview1')"/>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <div class="file-input">
                                            <input type="file" name="favicon" id="favicon" class="file-input__input"
                                                   onchange="singleImagePreview(event,'ImgPreview2')"/>
                                        ...
                                        <div class="d-flex align-items-center flex-wrap">
                                                                <span class="pip">
                                                                    <img class="imageThumb" id="ImgPreview2"
                                                                         src="{{ asset( river_settings('favicon')) }}">
                                                                </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="">
                                        <div class="file-input">
                                            <input type="file" name="header_logo" id="header_logo"
                                                   ...
                                                   onchange="singleImagePreview(event,'ImgPreview3')"/>
                                        ...
                                        <div class="d-flex align-items-center flex-wrap">
                                                        <span class="pip">
                                                            <img class="imageThumb" id="ImgPreview3"
                                                                 src="{{ asset( river_settings('header_logo')) }}">
                                                        </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="">
                                        <div class="file-input">
                                            <input type="file" name="footer_logo" id="footer_logo"
                                                   class="file-input__input"
                                                   onchange="singleImagePreview(event,'ImgPreview4')"/>
                                        ...
                                        <div class="d-flex align-items-center flex-wrap">
                                                        <span class="pip">
                                                            <img class="imageThumb" id="ImgPreview4"
                                                                 src="{{ asset( river_settings('footer_logo')) }}">
                                                        </span>
                                        </div>
                                    </div>
                                </div>
