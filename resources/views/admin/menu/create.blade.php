...
@section('page-header')
    <x:river::header>
            ...
            <x-slot:breads>
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="">Add Manu</a></li>
            </x-slot:breads>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body row">
                       <div class="col-md-8">
                           <form action="{{route('river.menu.store')}}" method="POST">
                               @csrf
                               <div class="form-group mb-3 ">
                                   <label class="form-label required">Name</label>
                                   <div>
                                       <input type="text" class="form-control generate-slug" data-slug-field="slug"  name="name" value="{{ old('name') }}">
                                   </div>
                               </div>
