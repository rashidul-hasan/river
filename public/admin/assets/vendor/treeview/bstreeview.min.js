    ...
    $.extend(bstreeView.prototype, {
        ...
        build: function (parentElement, nodes, depth) {
            ...
            $.each(nodes, function addNodes(id, node) {
                ...
                if (node.self_id) {
                    treeItem.attr('data-self_id', node.self_id);
                }
                if (node.parent_id) {
                    treeItem.attr('data-parent_id', node.parent_id);
                }

                // append button
                treeItem.append("<button class=\"btn btn-link btn-sm\"><i class='fa fa-edit'></i></button>");
