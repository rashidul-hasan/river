...
<div class="container marketing">
  ...
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner"> 
      @foreach( river_slider('slider') as $slider)
     <div class="carousel-item active">
       ...
       <div class="bd-placeholder-img" > 
         <img  width="100%" height="100%" src="{{$slider->image}}" />
       </div>
       ...
       <div class="container">
         <div class="carousel-caption">
           <h1>{{$slider->title}}</h1>
           <p>{{$slider->Subtitle}}</p>
           <p><a class="btn btn-lg btn-primary" href="{{$slider->button_one_url}}">{{$slider->button_one_text}}</a></p>
         </div>
       </div>
     </div>
     @endforeach
