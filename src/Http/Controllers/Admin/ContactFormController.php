...
class ContactFormController
{
    public function index()
    {
        ...
        return view('river::admin.contact_form.index', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('river.contact-form.edit', $file->id))
            ->with('success', 'Created!');
    }

    public function edit($id)
    {
        $file = ContactForm::find($id);


        $data = [
            'title' => 'Edit Contact Form: ' . $file->name,
            'type' => $file
        ];

        return view('river::admin.contact_form.edit', $data);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect(route('river.contact-form.index'))
